...
public class SingleLinkedList2Test {
    private SingleLinkedList2<Integer> intlist;
    private SingleLinkedList2<String> stringlist;
    private SingleLinkedList2<Character> charlist;

    @BeforeEach
    public void setUp() {
        intlist = new SingleLinkedList2<>();
        stringlist = new SingleLinkedList2<>();
        charlist = new SingleLinkedList2<>();
    }
